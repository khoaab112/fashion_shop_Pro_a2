    ...
    <div class="list-menu">
      <div class="menu_content">
        <ul class="menu_items" v-for="value in dataMenuSidebar" :key="value.name">
          <h3
            :class="{ 'menu-title-sidebar': true, 'show-titles': activeShowSidebar }"
          ...
          <!-- ở đây chia làm 2 loại
                    ...
                    -->
          <li class="item" v-show="checkShowMenuByRoles(value.role)">
            <div
              href="#"
            ...
            >
              ...
              >
                ...
                <span class="navlink" v-bind:hidden="!activeShowSidebar">{{
                  value.title
                }}</span>
                <div class="ml-auto p-2 down" v-if="value.children.length">
            ...
            <ul
              ...
              v-if="value.children.length && value.active"
        ...
        <ul class="menu_items last-menu"></ul>
      </div>
    </div>
  </nav>
</template>

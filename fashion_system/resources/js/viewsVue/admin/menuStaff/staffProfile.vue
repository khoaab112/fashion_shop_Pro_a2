<template>
  <div id="profile-staff">
    <!-- <section id="background-info-staff" style="
      ...
      "> -->
    <section
      id="background-info-staff"
      @mouseenter="eventHoverBackground(true)"
    ...
    >
      <avatar
        :src="urlAvatar"
        class="avatar-staff"
        @click="UploadAvatar('AVT')"
        @image-error="failureTracking"
      >
      </avatar>
      <div class="show-background" v-if="isShowIconEyeBackground">
        <font-awesome-icon
          ...
          fade
          class="icon-eye"
          @click="showPopupBackgroundStaff()"
        />
      </div>
      ...
      <div
        class="action-edit-height"
        @click="isEditHeightBackground = !isEditHeightBackground"
      >
        <font-awesome-icon
          :icon="['fas', 'up-down']"
          style="color: #ffffff"
          v-if="!isEditHeightBackground"
        />
        <font-awesome-icon
    ...
    <section id="avatar-staff">
      <div class="basic-information">
        ...
        <div
          class="action-page"
          :class="{ 'animate__animated animate__fadeInRight': isShowAction }"
        >
          <font-awesome-icon
    ...
    <section id="content-staff" v-show="!isEdit">
      <div class="container">
        <div class="row info">
          <twoColumnsOfData
            class="col-lg-6 col-sm-12 col-info-staff"
          ...
          <twoColumnsOfData
            class="col-lg-6 col-sm-12 col-info-position text-end"
            v-show="!isShowDetails"
          >
          </twoColumnsOfData>
    ...
    <section class="edit-info container" v-if="isEdit">
      ...
      <div class="submit">
        <button type="button" class="btn btn-primary" @click="updateDataStaff()">
          Cập nhật<loadingSpinner v-show="isLoadButtonData"></loadingSpinner>
        </button>
      </div>
    </section>
    <!-- dialog change password -->
    <el-dialog
      v-model="showPopupChangePassword"
      title="Đổi mật khẩu"
      width="30%"
      align-center
      @close="clearPassword"
  ...
  <upload-avatar
    ...
    :show="showUploadFile"
    :data="staff"
    @hide-upload="emitUpload"
    @upload-success="uploadSuccess"
  ></upload-avatar>
  <el-dialog v-model="showPopupBackground" title="Ảnh" width="70%" draggable>
    <div
      :style="`background-image: url(${backgroundStaff})`"
      class="show-background-popup"
    ></div>
  </el-dialog>
</template>

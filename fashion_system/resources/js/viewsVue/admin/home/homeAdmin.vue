  ...
  <div class="container">
    <div class="row v1">
      <section class="card card-notification col-5">
        <div class="header-notification-admin text-center">Thông báo</div>
      </section>
      <section class="col-7">
        <div class="header-link-account text-center">Kích hoạt tài khoản đã liên kết</div>
          ...
          <div class="card-weather">
            <div class="header-weather text-center">
              ...
              <div v-else>
                ...
                <div class="row lich-van-nien" v-if="dataLichVanLien">
                  <div class="col-6">
                    DL<br />{{ dataLichVanLien.days[0] }}&nbsp;{{
                      dataLichVanLien.dates[0]
                    }}
                  </div>
                  <div class="col-6">
                    AL<br />{{ dataLichVanLien.days[1] }}&nbsp;{{
                      dataLichVanLien.dates[1]
                    }}
                  </div>
                  <div class="col-6" style="color: #d9d9d9">
                    {{ dataLichVanLien.events[0] }}
                  </div>
                  <div class="col-6" style="color: #d9d9d9">
                    {{ dataLichVanLien.events[1] }}
                  </div>
            ...
            <div class="footer-weather">
              <div class="row" v-if="!loadingWeather">
                ...
                <div class="col-6">
                  Tốc độ gió : {{ dataWeather.wind.speed }}&nbsp;<font-awesome-icon
...
export default {
  ...
  methods: {
    testSendSocket() {
      ...
      window.Echo.private("channel-name").whisper("MessageNotification", {
    ...
    findDifference(arrOld, arrNew) {
      ...
      const missingElements = arrOld.filter(
        (itemOld) => !arrNew.some((itemNew) => itemNew.id === itemOld.id)
      );
    ...
    getListUsers(val) {
      ...
      if (!this.listAccountsAdminOld) {
        ...
        this.listAccountsAdminNew = arr;
        this.listAccountsOff = this.findDifference(
          this.listAccountsAdminOld,
    ...
    getTimeNow() {
      ...
      switch (timeNow.day) {
        ...
        case 6:
          ...
          break;
        case 7:
          convertDay = "thứ chủ nhật";
          break;
      }
      return (
        convertDay + ", ngày " + timeNow.date + "/" + timeNow.month + "/" + timeNow.year
      );
    },
    callOpenWeatherMap() {
      const data = {

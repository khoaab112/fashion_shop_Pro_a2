                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <a href="{{ env('APP_URL') }}" target="_blank"
                                                                            ...
                                                                            <img src="https://lh3.googleusercontent.com/d/1PICdSz4dWkfPm-LRMK4_fXiVjWHfgPMd"
                                                                                alt="Logo" border="0"
                                                                                width="90"
                                                                                style="display: block; width: 90px; max-width: 90px; min-width: 100px;">
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="images/image-2.png" alt="Image"
                                                                            title="Image"
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Yêu
                                                                        cầu cấp lại mật khẩu</span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello <strong> {{$account->first_name}}</strong></span></p>
                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #666666;">Hệ
                                                                        thống nhận thấy yêu cầu cấp lại mật khẩu cho tài
                                                                        <strong style="color: red"> {{$account->email}}</strong>.Việc thay đổi chỉ có hiệu lưc trong
                                                                        10 phút</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #666666;">Nhấn nút dưới để tiến hành thay đổi mật khẩu : </span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div align="left">
                                                                ...
                                                                <a href="{{$href}}" target="_blank" class="v-button"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:15px 40px;line-height:120%;"><span
                                                                            style="font-size: 18px; line-height: 21.6px;">Thay đổi mật khẩu</span></span>
                                                                </a>
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="font-size: 14px; line-height: 140%;"><span
                                                                    style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                            style="font-size: 16px; line-height: 22.4px;">Nếu không nhấn được nút hã copy đoạn sau, dán vào trình duyệt để tới trang đổi mật khẩu</span></em></span><br /><span
                                                                    style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                                style="font-size: 16px; line-height: 22.4px;">Vì lý do bảo mật, yêu cầu này đã được nhận từ thiết bị có địa chỉ IP : <strong>{{$ip}}</strong> sử dụng <strong>{{$browser}}</strong>. Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này hoặc liên hệ với bộ phận hỗ trợ nếu bạn có thắc mắc.</span></em></span><br /><span
                                                                        style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                                style="font-size: 16px; line-height: 22.4px;">&nbsp;</span></em></span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 16px; line-height: 22.4px; color: #ecf0f1;">Liên hệ :</span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">
                                                                        &nbsp;Hà Nội - Việt Nam</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">08493338210 | nguyenvankhoark@gmail.com</span></p>
                                                            </div>
